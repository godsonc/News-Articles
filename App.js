...
const App = () => {
    const [articles, setArtícles] = useState([])
    ...
    useEffect(() => {
        ...
        try {
            ...
            setArtícles(articles.response.docs)
        ...
        <>
          <div className="showcase">
            <div className="overlay px-5">
              <h1 className="text-4xl font-bold text-white text-center mb-4 capitalize lg:text-6xl">
